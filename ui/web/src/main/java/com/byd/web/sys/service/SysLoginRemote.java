...
public interface SysLoginRemote {
     ...
     * OA登录
     */
	@RequestMapping(value = "/admin-service/oalogin", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    public R oalogin(@RequestParam(value="params")  Map<String,Object> params);
