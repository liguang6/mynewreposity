...
public class SysLoginController {
	...
	public void logout(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (Constant.WEBGATE_IP.contains(remoteAddr)) {
//				response.sendRedirect("http://websso.byd.com.cn/oam/server/logout?end_url=http://wms.byd.com:8080");
				response.sendRedirect("https://webssotest.byd.com/oam/server/logout?end_url=http://10.9.38.172:8080");
			} else {
