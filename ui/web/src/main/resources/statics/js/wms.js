	...
	var js = {
		...
		loading: function(message, ignoreMessageIfExists) {
			...
			if (message == undefined || message == "") {
				message = '正在加载，请稍后...'||js.text("loading.message")
			}
			if (message == "none") {
				return
			}
		...
		showErrorMessage: function(responseText,timeout) {
			if (responseText && responseText != "") {
				...
				if (responseText.indexOf("<html ") != -1 || responseText.indexOf("<head ") != -1 || responseText.indexOf("<body ") != -1) {
					...
					js.showMessage(responseText, null, "error",timeout)
				}
			}
		},
		...
		1: [function(b, a) {
			...
			function() {
				...
				h.prototype.needsClick = function(i) {
					...
					var o, l;
					document.activeElement && document.activeElement !== m && document.activeElement.blur(), l = i.changedTouches[0], o = document.createEvent("MouseEvents"), o.initMouseEvent(this.determineEventType(m), !0, !0, window, 1, l.screenX, l.screenY, l.clientX, l.clientY, !1, !1, !1, !1, 0, null), o.forwardedTouchEvent = !0, m.dispatchEvent(o)
					...
					return this.trackingClick = !0, this.trackingClickStart = m.timeStamp, this.targetElement = i, this.touchStartX = o.pageX, this.touchStartY = o.pageY, m.timeStamp - this.lastClickTime < this.tapDelay && m.preventDefault(), !0
		...
		return "ontouchstart" in document ? this : (b = b.add(this.parent()), this.each(function() {
			function f() {
				m.parents(".navbar").find(".navbar-toggle").is(":visible") || (c.clearTimeout(o), c.clearTimeout(j), j = c.setTimeout(function() {
					b.find(":focus").blur(), p.instantlyCloseOthers === !0 && b.removeClass("open"), c.clearTimeout(j), m.attr("aria-expanded", "true"), t.addClass("open"), m.trigger(k)
				}, p.hoverDelay))
			}
			var o, j, m = a(this),
				t = m.parent(),
