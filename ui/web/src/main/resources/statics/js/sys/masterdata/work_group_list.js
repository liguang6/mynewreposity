$(function () {
    $("#dataGrid").dataGrid({
        ...
        columnModel: [			
			{ label: '班组代码', name: 'CODE', index: 'CODE', width: 80,align:'center' },
			{ label: '班组名称', name: 'NAME', index: 'NAME', width: 80,align:'center' },
  ...
  //------删除操作---------
	  ...
	  $("#newOperation").click(function(){
		   var options = {
	    		...
	    		maxmin: true,
	    		shadeClose: true,
	    		title: '<i aria-hidden="true" class="fa fa-plus">&nbsp;</i>新增班组',
	    		area: ["400px", "300px"],
	    		content: "sys/masterdata/work_group_edit.html",  
	  ...
	  $("#editOperation").click(function(){
		 ...
		 if(gr !== null && gr!==undefined){
			 ...
			 var options = {
				...
				maxmin: true,
				shadeClose: true,
				title: '<i aria-hidden="true" class="fa fa-pencil-square-o">&nbsp;</i>修改班组',
				area: ["400px", "300px"],
				content: 'sys/masterdata/work_group_edit.html',
				btn: ['<i class="fa fa-check"></i> 确定'],
				success:function(layero, index){
