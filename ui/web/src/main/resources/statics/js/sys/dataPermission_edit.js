...
var vm = new Vue({
    ...
    methods:{
    	getAutuRole:function(roleId,roleName){
			$("#roleId").val(roleId);
    	...
    	getInfo:function(ID){
			$.ajax({
	            type: "GET",
	            url: baseURL + "sys/dataPermission/info?id="+ID,
	            contentType: "application/json",
	            success: function(r){
					//vm.storage = r.dataPermissionResult;
					$("#Id").val(r.dataPermissionResult.ID);
					$("#roleId").val(r.dataPermissionResult.ROLEID);
					$("#roleName").val(r.dataPermissionResult.ROLENAME);
...
//					$("#userName").val(r.dataPermissionResult.USERNAME);
...
// 	$.ajax({
// 		type: "GET",
// 		url: baseURL + "sys/dataPermission/getAuthFields?menuId="+menuId,
// 		contentType: "application/json",
// 		success: function(r){
// 			$("#authFields").val(r.dataPermissionResult.AUTHFIELDS);
// 		}
...
$("#saveForm").validate({
	...
	submitHandler: function(form){
		...
		if($("#Id").val()==null || $("#Id").val()==""){
			url = "sys/dataPermission/save";
		}else {
			url = "sys/dataPermission/update";
		}
