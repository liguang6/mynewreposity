$(function () {
    $("#dataGrid").dataGrid({
        ...
        columnModel: [			
			...
			{ label: '存放区代码', name: 'areaCode', index: 'areaCode', width: 80,align:'center'  }, 			
			{ label: '存放区名称', name: 'areaName', index: 'areaName', width: 80,align:'center'  }, 			
  ...
  //------删除操作---------
	  $("#deleteOperation").click(function(){
		  ...
		  if (gr != null  && gr!==undefined) {
			  layer.confirm('确定删除选中的记录?', {icon: 3, title:'提示'}, function(index){
				  ...
				  $.ajax({
					type: "POST",
				    url: baseURL + "config/area/delById?id="+grData.id,
	  ...
	  $("#newOperation").click(function(){
		   var options = {
	    		...
	    		maxmin: true,
	    		shadeClose: true,
	    		title: '<i aria-hidden="true" class="fa fa-plus">&nbsp;</i>新增收料房存放区',
	    		area: ["500px", "240px"],
	    		content: baseURL + "wms/config/wms_c_gr_area_edit.html",  
	  ...
	  $("#editOperation").click(function(){
		 ...
		 if(gr !== null && gr!==undefined){
			 ...
			 var options = {
				...
				maxmin: true,
				shadeClose: true,
				title: '<i aria-hidden="true" class="fa fa-pencil-square-o">&nbsp;</i>修改收料房存放区',
				area: ["500px", "240px"],
				content: baseURL + 'wms/config/wms_c_gr_area_edit.html',
				btn: ['<i class="fa fa-check"></i> 确定'],
				success:function(layero, index){
