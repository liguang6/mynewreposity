...
$(function () {
    $('#dataGrid').dataGrid({
        ...
        columnModel: [
            ...
            {header:'物料编码', name:'MATNR', width:70, sortable: false,align:"center"},
            {header:'物料描述', name:'MAKTX', width:70, sortable: false,align:"center"},
            {header:'单位', name:'MEINS', width:45, sortable: false,align:"center"},
            {header:'库存状态', name:'SOBKZ', width:70, sortable: false,align:"center"},
            {header:'库存地点', name:'LGORT', width:70, sortable: false,align:"center"},
            {header:'托盘', name:'TPNUM', width:45, sortable: false,align:"center"},
            {header:'立库仓位', name:'LK_BIN_CODE', width:70, sortable: false,align:"center"},
            {header:'批次', name:'BATCH', width:45, sortable: false,align:"center"},
            {header:'条码ID', name:'LABEL_NO', width:70, sortable: false,align:"center"},
            {header:'供应商', name:'LIFNR', width:60, sortable: false,align:"center"},
            {header:'供应商描述', name:'LIKTX', width:80, sortable: false,align:"center"},
            {header:'数量', name:'QTY', width:45, sortable: false,align:"center"},
            {header:'序列号', name:'SERID', width:60, sortable: false,align:"center"},
            {header:'包条码ID', name:'Pack_LABEL_NO', width:80, sortable: false,align:"center"},
            {header:'栈板条码ID', name:'pallet_label_no', width:100, sortable: false,align:"center"},
        ],
        viewrecords: true,
        shrinkToFit:false,
        showCheckbox:false,
...
function export2Excel(){
    var column= [
        {title:'工厂', name:'WERKS', align:"center"},
        {title:'仓库号', name:'WH_NUMBER',  align:"center"},
        {title:'物料编码', name:'MATNR', align:"center"},
        {title:'物料描述', name:'MAKTX', align:"center"},
        {title:'单位', name:'MEINS', align:"center"},
        {title:'库存状态', name:'SOBKZ', align:"center"},
        {title:'库存地点', name:'LGORT', align:"center"},
        {title:'托盘', name:'TPNUM', align:"center"},
        {title:'立库仓位', name:'LK_BIN_CODE', align:"center"},
        {title:'批次', name:'BATCH', align:"center"},
        {title:'条码ID', name:'LABEL_NO', align:"center"},
        {title:'供应商', name:'LIFNR', align:"center"},
        {title:'供应商描述', name:'LIKTX', align:"center"},
        {title:'数量', name:'QTY', align:"center"},
        {title:'序列号', name:'SERID', align:"center"},
        {title:'包条码ID', name:'Pack_LABEL_NO', align:"center"},
        {title:'栈板条码ID', name:'pallet_label_no', align:"center"},
    ]
    var results=[];
    ...
    params=l;
    $.ajax({
        url:baseURL+"report/stateLibrary/list",
        dataType : "json",
        type : "post",
        data : params,
        async: false,
...
//	getMergeTable(results,column,rowGroups,"出入库库存报表");
    toExcel("立库库存查询报表",results,column);
}
