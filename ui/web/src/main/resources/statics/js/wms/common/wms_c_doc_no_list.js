$(function(){
	  ...
	  $("#dataGrid").dataGrid({
	        ...
	        datatype: "json",
	        colModel: [			
	            {label: '系统代码', name: 'sys',index:"sys", width: 100,align:"center"},
				{label: '工厂代码', name: 'werks',index:"werks", width: 100,align:"center"},
				{label: '单据类型', name: 'docType',index:"docType", width: 100,align:"center",hidden:true},
				{label: '单据类型', name: 'docTypeName',index:"docTypeName", width: 100,align:"center"},
				{label: '编号前缀', name: 'preNo',index:"preNo", width: 100,align:"center"},
				{label: '编号后缀', name: 'backNo',index:"backNo", width: 100,align:"center"},
				{label: '起始号', name: 'startNo',index:"startNo", width: 100,align:"center"},
				{label: '递增', name: 'incrementNum',index:"incrementNum", width: 100,align:"center"},
				{label: '编号长度', name: 'noLength',index:"noLength", width: 100,align:"center"},
				{label: '当前编号', name: 'currentNo',index:"currentNo", width: 100,align:"center"},
				{label: '创建人', name: 'creator',index:"creator", width: 100,align:"center"},
				{label: '创建时间', name: 'createDate',index:"createDate", width: 100,align:"center"},
	  ...
	  $("#newOperation").click(function(){
			js.layer.open({
				...
				title: "新增单据编号规则",
				area: ["70%", "50%"],
				content: baseUrl + "wms/common/wms_c_doc_no_edit.html",
				closeBtn:1,
				end:function(){
					$("#searchForm").submit();
				},
	  ...
	  $("#editOperation").click(function(){
		 ...
		 if(gr !== null && gr!==undefined){
			 ...
			 var options = {
				...
				maxmin: true,
				shadeClose: true,
				title: '<i aria-hidden="true" class="fa fa-pencil-square-o">&nbsp;</i>编辑单据编号规则',
				area: ["60%", "50%"],
				content: baseURL + 'wms/common/wms_c_doc_no_edit.html',
