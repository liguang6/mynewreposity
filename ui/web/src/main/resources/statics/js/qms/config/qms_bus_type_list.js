$(function () {
    $("#dataGrid").dataGrid({
        ...
        columnModel: [	
        	{ label: '车型', name: 'busTypeCode', index: 'busTypeCode', width: 180,align:'center'  }, 	
			{ label: '检验类别', name: 'testType', index: 'testType', width: 180,align:'center' },
			{ label: '创建人员', name: 'creator', index: 'creator', width: 180,align:'center'  }, 			
			{ label: '创建时间', name: 'createDate', index: 'createDate', width: 180,align:'center'  },
  ...
  //------删除操作---------
	  $("#deleteOperation").click(function(){
		  ...
		  if (gr != null  && gr!==undefined) {
			  layer.confirm('确定删除选中的记录?', {icon: 3, title:'提示'}, function(index){
				  ...
				  $.ajax({
					type: "POST",
				    url: baseURL + "qms/config/busType/delById/"+grData.id,
	  ...
	  $("#newOperation").click(function(){
		   var options = {
	    		...
	    		area: ["560px", "260px"],
	    		content: "qms/config/qms_bus_type_edit.html",  
