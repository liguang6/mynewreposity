export default {
  login_placeholder_userName: 'please enter userName',
  login_placeholder_password: 'please enter password',
  login_rules_userName: 'userName can not be blank',
  login_rules_password: 'password can not be blank',
  login_welcome: 'Welcome to use BYD-WMS',
  login_tips: 'Username defaults to job number',
  bms: 'BMS',
  home: 'Home',
  login: 'Login',
