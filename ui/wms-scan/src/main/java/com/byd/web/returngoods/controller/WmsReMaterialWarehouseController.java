 ...
 */
@RestController
@RequestMapping("returngoods/wmsReMaterialWarehouse")
public class WmsReMaterialWarehouseController {
	...
	public Map<String,Object> initParams(Map<String,Object> params){
		try {
			//选择仓库号存储在session里面的值
			params.put("WH_NUMBER", httpSession.getAttribute("warehouse"));
			params.put("WERKS", httpSession.getAttribute("werks"));
			params.put("USER_NAME", userUtils.getUser().get("USERNAME"));
			params.put("MENU_KEY", "PDA_RW_312");
