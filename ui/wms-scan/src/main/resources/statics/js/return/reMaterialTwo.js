$(function () {
    ...
    $("#dataGrid1").jqGrid({
        url : baseUrl + "returngoods/reMaterialTwo/scanTwo",
        datatype: "json",
        postData:{"LABEL_NO":$("#LABEL_NO").val()},
        jsonReader: jsonreader,
        colNames:['物料号','<span style="color:red">*</span><span style="color:blue"><b>生产订单</b></span>',
        ...
        colModel:[
            ...
            {name:'SOBKZ',index:'SOBKZ', width:50, align:'center'},
...
//	$("#dataGrid").trigger("reloadGrid");
    ...
    $("#dataGrid").jqGrid({
        url : baseUrl + "returngoods/reMaterialTwo/scanInfoTwo",
        datatype: "json",
        jsonReader: jsonreader,
    ...
    $("#btn7").click(function () {
        ...
        if(validate=="") {
            ...
            $.ajax({
                url: baseUrl + "returngoods/reMaterialTwo/removeTwo",
                dataType: "json",
                type: "post",
...
function saveData() {
    ...
    $.ajax({
        url: baseUrl + "returngoods/reMaterialTwo/saveData",
        dataType: "json",
        type: "post",
...
function confirm(){
    ...
    if(validate == "") {
        ...
        $("#btn5").click(function () {
            ...
            $.ajax({
                url: baseUrl + "returngoods/reMaterialTwo/confirmWorkshopReturnTwo",
                dataType: "json",
                type: "post",
                data: {
...
function scanPre(){
    $.ajax({
     dataType:'json',
        type:'post',
        url:baseUrl + "returngoods/reMaterialTwo/valiateLabelTwo",
