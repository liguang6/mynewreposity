...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.byd.admin.common.annotation.SysLog)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		//用户名
		String username = userUtils.getUser().get("USERNAME").toString()+"："+userUtils.getUser().get("FULL_NAME").toString();
