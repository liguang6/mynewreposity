...
import com.byd.admin.modules.sys.dao.SysConfigDao;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigDao, SysConfigEntity> implements SysConfigService {
	...
	public PageUtils queryPage(Map<String, Object> params) {
		Page<SysConfigEntity> page = null;
        String paramKey = (String)params.get("paramKey");
        page = new Query<SysConfigEntity>(params).getPage();
        if(page.getLimit()==-1) {
        	List<SysConfigEntity> records = this.selectList(new EntityWrapper<SysConfigEntity>()
