...
package com.byd.admin.common.aspect;
...
public class DataFilterAspect {
    ...
    @Pointcut("@annotation(com.byd.admin.common.annotation.DataFilter)")
    ...
    public void dataFilter(JoinPoint point) throws Throwable {
        ...
        if(params != null && params instanceof Map){
            ...
            //如果不是超级管理员，则进行数据过滤
            if(Integer.valueOf(user.get("USER_ID").toString()) != Constant.SUPER_ADMIN){
                Map map = (Map)params;
     ...
     * 获取数据过滤的SQL
     */
    private String getSQLFilter(Map<String,Object> user, JoinPoint point){
...
/*        //用户角色对应的部门ID列表
        ...
        //用户分配的部门ID列表
        deptIdList.addAll(sysUserDeptService.queryDeptIdList(user.getUserId()));
        ...
        if(dataFilter.user()){
            ...
            sqlFilter.append(tableAlias).append(dataFilter.userId()).append("=").append(user.get("USER_ID"));
        }
