 ...
 */
@RestController
@RequestMapping("config/qmsBusType")
public class QmsBusTypeController {
    @Autowired
    private QmsBusTypeService qmsBusTypeService;
    ...
    public R queryPage(@RequestBody Map<String, Object> params){
        PageUtils page = qmsBusTypeService.queryPage(params);
    ...
    public R getList(@RequestBody Map<String, Object> params){
        List<Map<String,Object>> list = qmsBusTypeService.getList(params);
    ...
    public R queryDetail(@PathVariable("id") Long id){
        Map<String,Object> entity = qmsBusTypeService.getById(id);
    ...
    public R save(@RequestBody Map<String, Object> param){
    	...
    	List<Map<String,Object>> list=qmsBusTypeService.getList(map);
    	if(list.size()>0) {
    		return R.error("检验节点【"+param.get("testNode").toString()+"】信息已维护!");
    	}
    	int result=qmsBusTypeService.save(param);
    ...
    public R update(@RequestBody Map<String, Object> param){
    	...
    	int result=qmsBusTypeService.update(param);
    ...
    public R delById(@PathVariable("id") Long id){
    	...
    	int result=qmsBusTypeService.delete(id);
