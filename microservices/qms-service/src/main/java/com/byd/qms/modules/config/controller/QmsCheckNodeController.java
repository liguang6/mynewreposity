 ...
 */
@RestController
@RequestMapping("config/qmsCheckNode")
public class QmsCheckNodeController {
    @Autowired
    private QmsCheckNodeService qmsCheckNodeService;
    ...
    public R queryPage(@RequestBody Map<String, Object> params){
        PageUtils page = qmsCheckNodeService.queryPage(params);
    ...
    public R getList(@RequestBody Map<String, Object> params){
        List<Map<String,Object>> list = qmsCheckNodeService.getList(params);
    ...
    public R queryDetail(@PathVariable("id") Long id){
        Map<String,Object> entity = qmsCheckNodeService.getById(id);
    ...
    public R save(@RequestBody Map<String, Object> param){
    	...
    	List<Map<String,Object>> list=qmsCheckNodeService.getList(map);
    	if(list.size()>0) {
    		return R.error("检验节点【"+param.get("testNode").toString()+"】信息已维护!");
    	}
    	int result=qmsCheckNodeService.save(param);
    ...
    public R update(@RequestBody Map<String, Object> param){
    	...
    	int result=qmsCheckNodeService.update(param);
    ...
    public R delById(@PathVariable("id") Long id){
    	...
    	int result=qmsCheckNodeService.delete(id);
