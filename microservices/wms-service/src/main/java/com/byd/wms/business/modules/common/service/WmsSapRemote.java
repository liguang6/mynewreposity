...
public interface WmsSapRemote {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/sap-service/SapCustomerSync", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	Map<String,Object> getSapCustomerSync(@RequestParam(value = "params") String params);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/sap-service/createStoPO", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	Map<String,Object> createStoPO(@RequestBody Map<String,Object> params);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/sap-service/createStoDN", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	Map<String,Object> createStoDN(@RequestBody Map<String,Object> params);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/sap-service/postDN", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	Map<String,Object> postDN(@RequestParam(value = "werks") String werks,@RequestParam(value = "vbeln") String vbeln);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/sap-service/queryMaterialStock", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	Map<String,Object> queryMaterialStock(@RequestBody Map<String,Object> params);
}
