 ...
 */
@TableName("WMS_QC_RECORD")
@KeySequence("SEQ_WMS_QC_RECORD")
public class WmsQcRecordEntity implements Serializable {
	 ...
	 * 检验记录号 系统产生
	 */
	private String qcRecordNo;
	/**
	 * 检验记录行项目号
	 */
	private String qcRecordItemNo;
	/**
	 * 送检单号 删除送检单时送检结果同步删除
	 */
	 ...
	 * 设置：检验记录号 系统产生
	 */
	public void setQcRecordNo(String qcRecordNo) {
		this.qcRecordNo = qcRecordNo;
	}
	/**
	 * 获取：检验记录号 系统产生
	 */
	public String getQcRecordNo() {
		return qcRecordNo;
	}
	/**
	 * 设置：检验记录行项目号
	 */
	public void setQcRecordItemNo(String qcRecordItemNo) {
		this.qcRecordItemNo = qcRecordItemNo;
	}
	/**
	 * 获取：检验记录行项目号
	 */
	public String getQcRecordItemNo() {
		return qcRecordItemNo;
	}
	/**
	 ...
	 * 设置：数量
	 */
	public void setRecordQty(Double qty) {
		this.recordQty = qty;
	}
	/**
	 * 获取：数量
