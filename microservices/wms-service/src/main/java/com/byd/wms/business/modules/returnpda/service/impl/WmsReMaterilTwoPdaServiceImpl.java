...
import com.byd.wms.business.modules.returnpda.dao.WmsReMaterialTwoPdaDao;
 ...
 */
@Service
public class WmsReMaterilTwoPdaServiceImpl implements WmsReMaterialTwoPdaService {
    @Autowired
    private WmsReMaterialTwoPdaDao wmsReMaterialTwoPdaDao;
    @Autowired
    ...
    public void insertScanCache(Map<String,Object> params) {
        //插入缓存表
         wmsReMaterialTwoPdaDao.insertScanCache(params);
    }
    /**
     * 将条码插入条码明细表
     * @param params
    ...
    public void insertBarCodeLog(Map<String,Object> params) {
        ...
        list= (List<Map<String,Object>>)JSON.parse(params.get("params").toString());
        int index = list.size(),i;
        String[] arr = new String[index];
       for(i =0;i<index;i++){
           arr[i] = (String)list.get(i).get("LABEL_NO");
        }
        params.put("LABEL_NO",arr);
        wmsReMaterialTwoPdaDao.insertBarCodeLog(params);
    }
    /**
     * 条码号用数组保存到对应WMS凭证明细表。
     * @param params
    ...
    public void insertWmsPZ(Map<String,Object> params) {
        //插入缓存表
        wmsReMaterialTwoPdaDao.insertWmsPZ(params);
    }
    /**
    ...
    public void updataCoreLabel(Map<String,Object> params) {
        //插入缓存表
        wmsReMaterialTwoPdaDao.updataCoreLabel(params);
    }
    /**
     * 分组获取数据表
     * @param params
    ...
    public PageUtils getPorecCache(Map<String, Object> params) {
        ...
        result = wmsReMaterialTwoPdaDao.getPorecCache(params);
    ...
    public PageUtils getScanInfo(Map<String,Object> params){
        ...
        map.putAll(params);
        int i = 0;
          a = wmsReMaterialTwoPdaDao.getScanInfo(map);
    ...
    public int removeScanInfo(Map<String,Object>  params){
       ...
       return wmsReMaterialTwoPdaDao.removeScanInfo(params);
    }
    /**
     * 保存数据
     * @param params
    ...
    public void saveData(Map<String,Object> params){
        ...
        wmsReMaterialTwoPdaDao.saveData(params);
    }
    ...
    public Map<String, Object> getWmsDocByLabelNo(Map<String,Object> params){
         ...
         a = wmsReMaterialTwoPdaDao.getWmsDocByLabelNo(params);
         //获取库存类型，供应商代码，装箱数量
         b = wmsReMaterialTwoPdaDao.getWmsQTYByLabel(params);
         //获取批次
         c = wmsReMaterialTwoPdaDao.getWmsBatchByLabel(params);
