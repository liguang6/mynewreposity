...
@RestController
@RequestMapping("knpda/stockTransferD")
public class WmsPdaKnStockTransferDController {
    ...
    public R save(@RequestBody Map<String, Object> params){
    	...
    	JSONObject.parseArray(matListStr, Map.class).forEach(m->{
    		...
    		m.put("BUSINESS_NAME", "411E");
    		String f_lgort=m.get("F_LGORT").toString();
    		JSONObject target=new JSONObject(); 
    		target.put("F_LGORT", f_lgort);
    		target.put("SO_NO",params.get("SO_NO"));
    		target.put("SO_ITEM_NO",params.get("SO_ITEM_NO"));
