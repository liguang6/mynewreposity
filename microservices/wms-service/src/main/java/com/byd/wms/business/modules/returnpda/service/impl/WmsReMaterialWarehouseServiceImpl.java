 ...
 */
@Service
public class WmsReMaterialWarehouseServiceImpl implements WmsReMaterialWarehouseService {


	@Autowired
	private WmsReMaterialWarehouseDao wmsReMaterialWarehouseDao;
	@Autowired
	...
	public Map<String, Object> poReceiptPdaIn(Map<String, Object> params) {
		...
		for (int j = 0; j < jarr.size(); j++) {
			...
			itemDetailMap.put("MOVE_STLOC", outData.getString("MOVE_STLOC"));
