...
public class WmsOutRequirementItemEntity implements Serializable {
	 ...
	 * 配送单行
	 */
	private String dispatchingItemNo;
	...
	public String getDispatchingItemNo() {
		return dispatchingItemNo;
	}
	public void setDispatchingItemNo(String dispatchingItemNo) {
		this.dispatchingItemNo = dispatchingItemNo;
	}
	...
	public String toString() {
		return "WmsOutRequirementItemEntity{" +
				"id=" + id +
				...
				", requirementItemNo='" + requirementItemNo + '\'' +
				...
				", qtyCancel=" + qtyCancel +
				", lgort='" + lgort + '\'' +
				", receiveLgort='" + receiveLgort + '\'' +
				", boxCount=" + boxCount +
				", sortSeq='" + sortSeq + '\'' +
				", lifnr='" + lifnr + '\'' +
				", hxFlag='" + hxFlag + '\'' +
				", sapMatdocNo='" + sapMatdocNo + '\'' +
				", sapMatdocItemNo='" + sapMatdocItemNo + '\'' +
				", dispatchingNo='" + dispatchingNo + '\'' +
				", dispatchingItemNo='" + dispatchingItemNo + '\'' +
				'}';
	}
}
