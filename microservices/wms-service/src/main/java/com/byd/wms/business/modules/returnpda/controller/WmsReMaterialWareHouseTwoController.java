 ...
 */
@RestController
@RequestMapping("retrunpda/wmsReMaterialTwoWarehouse")
public class WmsReMaterialWareHouseTwoController {


	@Autowired
	private WmsReMaterialWarehouseTwoService wmsReMaterialWarehouseTwoService;
	@Autowired
	...
	public R getPorecCache(@RequestBody Map<String, Object> params){
		...
		try {
			...
			PageUtils page = wmsReMaterialWarehouseTwoService.getGridPoreDataPage(params);
			R r= wmsReMaterialWarehouseTwoService.getPorecCache(params);
			r.put("page", page);
			return r;
	...
	public R validatePoReceiptLable(@RequestBody Map<String, Object> params){
		...
		try{
			this.initParams(params);
			return wmsReMaterialWarehouseTwoService.validatePoReceiptLable(params);
		} catch (Exception e) {
			//e.printStackTrace();
			return R.error(e.getMessage());
		}
	...
	public R getPoDetailByBarcode(@RequestBody Map<String, Object> params){
		...
		try {
			this.initParams(params);
			return wmsReMaterialWarehouseTwoService.getPoDetailByBarcode(params);//查询单个标签
	...
	public R getBarGridPoreData(@RequestParam Map<String, Object> params){
		this.initParams(params);
		PageUtils page = wmsReMaterialWarehouseTwoService.getBarGridPoreDataPage(params);
		return R.ok().put("page", page);
	}
	...
	public R poReDeleteBarInfo(@RequestParam Map<String, Object> params){
		this.initParams(params);
		return wmsReMaterialWarehouseTwoService.poReDeleteBarInfo(params);
	}
	...
	public R poReceiptPdaIn(@RequestBody Map<String, Object> params){
		...
		String msg = "";
		try {
			result = wmsReMaterialWarehouseTwoService.poReceiptPdaIn(params);
		} catch (Exception e) {
			return R.error(e.getMessage());
		}
